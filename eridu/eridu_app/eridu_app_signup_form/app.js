...
function registraionForm(name = '', email = '', phone = '') {
    ...
    <div id="signup_form">
        ...
        <div id="form_wrapper">
            <form action="" id="eridu_signup_form" class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="valid-feedback">This email is ready to use!</div>
                </div>
                <div class="input-group mb-3">
                    ...
                    <div class="valid-feedback">This phone number is ready to use!</div>
                </div>
                <div class="input-group mb-3">
        ...
        <div>
            <div><a class="btn btn-primary" href="#reset">Back</a></div>
